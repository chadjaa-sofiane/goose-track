        ...
        <header>
            <div className="flex items-center">
                <div className="flex-1 flex items-center justify-between">
                    ...
                    <h1 className="hidden font-bold text-[2rem] lg:block">
                        {title}
                    </h1>
                </div>
                <div className="flex items-center gap-x-[1.625em]">
                    <Button className="font-semibold text-xs md:text-lg px-8 py-3">
                        {' '}
                        Feedback{' '}
                    </Button>
                    <div className="flex items-center gap-x-2">
                        ...
                        <div className="w-8 h-8 md:w-[2.75em] md:h-[2.75em] rounded-full bg-accents-4/70"></div>
                    </div>
                </div>
            </div>
        </header>
